...
#
# Local modification: SKILLS_ROOT points at .claude/skills/ instead of the
# tool's own grandparent, because skills live there in this repo. Tool logic is
# otherwise unchanged, so upstream fixes can be re-pulled cleanly.
# ---------------------------------------------------------------------------
"""
...
SKILLS_ROOT = os.path.abspath(os.path.join(HERE, "..", "..", ".claude", "skills"))
